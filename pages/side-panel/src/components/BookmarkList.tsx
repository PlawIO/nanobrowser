            ...
            {editingId === bookmark.id ? (
              <div className="flex items-center">
                <input
                  ...
                  className="mr-2 grow border px-2 py-1 text-sm outline-none"
                  style={{
            ...
            {editingId !== bookmark.id && (
              <>
                <button
                  ...
                  className="absolute right-[28px] top-1/2 z-10 -translate-y-1/2 p-1 opacity-0 transition-opacity duration-200 group-hover:opacity-100"
                ...
                <button
                  ...
                  className="absolute right-2 top-1/2 z-10 -translate-y-1/2 p-1 opacity-0 transition-opacity duration-200 group-hover:opacity-100"
